...
bool Item_func_set_collation::fix_length_and_dec()
{
  if (agg_arg_charsets_for_string_result(collation, args, 1))
    return true;
  Lex_collation cl(collation.collation, Lex_collation::TYPE_IMPLICIT);
  if (cl.merge_charset_clause_and_collate_clause(m_set_collation))
    return true;
  collation.set(cl.collation(), DERIVATION_EXPLICIT,
...
void Item_func_set_collation::print(String *str, enum_query_type query_type)
{
  ...
  str->append(m_set_collation.name_for_show());
}
