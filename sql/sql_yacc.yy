...
field_type_or_serial:
          ...
          field_def
          {
            Lex_collation tmp= $1.lex_collation();
            if (tmp.merge_charset_clause_and_collate_clause($3))
              MYSQL_YYABORT;
            Lex->last_field->set_lex_collation(tmp);
          }
        | SERIAL_SYM
          {
...
field_type_string:
        ...
        | nchar opt_field_length opt_bin_mod
          {
            $$.set(&type_handler_string, $2, Lex_collation::national($3));
          }
        ...
        | nvarchar opt_field_length opt_compressed opt_bin_mod
          {
            $$.set(&type_handler_varchar, $2, Lex_collation::national($4));
          }
...
field_type_misc:
          ...
          { $$.set(&type_handler_enum, $5.collation()); }
        | SET '(' string_list ')' opt_binary
          { $$.set(&type_handler_set, $5.collation()); }
        ;
...
binary:
        ...
        | BINARY { $$.set_collate_contextually_typed(&my_charset_bin); }
        ...
        | json_table_field_type PATH_SYM json_text_literal
            json_opt_on_empty_or_error
          {
            ...
            if (Lex->json_table->m_cur_json_table_column->
                  set(thd, Json_table_column::PATH, $3, $1.lex_collation()))
            {
              MYSQL_YYABORT;
            }
          }
...
option_value_no_option_type:
        ...
        | NAMES_SYM charset_name_or_default
                    opt_collate_explicit_or_context_or_default
          {
            Lex_collation cs($2 ? $2 :
                                  global_system_variables.character_set_client,
                             Lex_collation_st::TYPE_IMPLICIT);
            if (unlikely(cs.merge_charset_clause_and_collate_clause($3)))
              MYSQL_YYABORT;
            if (sp_create_assignment_lex(thd, $1.pos()))
              MYSQL_YYABORT;
            LEX *lex= Lex;
            CHARSET_INFO *cs3= cs.collation();
            set_var_collation_client *var;
